...
from pix_scaler import MixtureScaler
...
a2b_save_path = './models/face2-a2b.ckpt'
b2a_save_path = './models/face2-b2a.ckpt'
da_save_path = './models/face2-da.ckpt'
db_save_path = './models/face2-db.ckpt'
