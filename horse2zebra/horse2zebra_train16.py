...
from models_model.model_models6 import UNet, Discriminator, DCModel, GCModel
...
GC.compile(optimizer=kr.optimizers.Adam(),
           loss=kr.losses.mean_absolute_error,
...
epoch_save_path = 'outputs/images3/epoch.npy'
epoch, first = 0, True
