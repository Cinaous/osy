...
from models_model.model_models8 import UNet, Discriminator, DCModel, GCModel
...
for horse, zebra in dataset:
    if epoch % 2 == 0 or first:
        ...
        cv2.imwrite('outputs/images5/trainA&z_%d.jpg' % epoch, img3)
