...
GC_save_path = 'outputs/GC21.ckpt'
epoch_save_path = 'outputs/images21/epoch.npy'
loss_save_path = 'outputs/images21/loss.npy'
...
for horse, zebra in dataset:
    if epoch % 2 == 0 or first:
        ...
        cv2.imwrite('outputs/images21/trainA&z_%d.jpg' % epoch, img3)
