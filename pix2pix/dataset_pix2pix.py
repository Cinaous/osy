...
from pix_scaler import MrScaler, M3Scaler, FixedScaler, StandardScaler, MixtureScaler


class Dataset:
    def __init__(self, data_dir, size=64, batch_size=1, scale=10, rotate=False):
