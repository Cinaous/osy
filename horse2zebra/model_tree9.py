...
def conv_init(units, num):
    return kr.Sequential([
        *[kr.layers.Conv2D(units, 3) for _ in range(num)],
...
def unet_init(units, num):
    return kr.Sequential([
        ...
        *[kr.layers.Conv2DTranspose(units, 3) for _ in range(num)],
        kr.layers.LayerNormalization(),
        activation,
        kr.layers.Dropout(.2)
    ])
...
class Tree(kr.Model, ABC):
    def __init__(self):
        ...
        # 128 - 4 = 124 = 62
        self.conv1 = conv_init(192, 2)
        # 62 - 6 = 56 = 28
        self.conv2 = conv_init(384, 3)
        # 28 - 8 = 20 = 10
        self.conv3 = conv_init(768, 4)
        self.last = kr.layers.Conv2D(2, 3, 1, 'same')
...
class TreeUNet(kr.Model, ABC):
    def __init__(self):
        ...
        self.conv3 = conv_init(768, 4)
        # 20 + 8 = 28
        self.unet1 = unet_init(384, 4)
        # 56 + 6 = 62
        self.unet2 = unet_init(192, 3)
        # 124 + 4 = 128
        self.unet3 = unet_init(96, 2)
        self.last = kr.layers.Conv2DTranspose(3, 1)
