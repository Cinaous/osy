...
from trm.conv_transformer3 import SkipModel, create_skips
...
H2Z = kr.Sequential([
    SkipModel(create_skips([(24, 5, 2), (48, 3, 2), (96, 3, 2)], splits=2)),
    SkipModel(create_skips([(48, 3, 2), (24, 3, 2), (3, 5, 2)], con=kr.layers.Conv2DTranspose, splits=1))
])
Z2H = kr.Sequential([
    SkipModel(create_skips([(24, 5, 2), (48, 3, 2), (96, 3, 2)], splits=2)),
    SkipModel(create_skips([(48, 3, 2), (24, 3, 2), (3, 5, 2)], con=kr.layers.Conv2DTranspose, splits=1))
...
cycle_lambda, z_cache, h_cache = 1, Cache(), Cache()
