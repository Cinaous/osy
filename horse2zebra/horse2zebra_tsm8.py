...
GC_save_path = 'outputs/GC30.ckpt'
DC_save_path = 'outputs/DC30.ckpt'
epoch_save_path = 'outputs/images30/epoch.npy'
loss_save_path = 'outputs/images30/loss.npy'
...
init_lr = 1e-2 if init_lr is None else init_lr
g_schedue = StepsLearningRateDecay(.2 * init_lr)
...
for horse, zebra in dataset:
    if epoch % 50 == 0 or first:
        ...
        cv2.imwrite('outputs/images30/trainA&z_%d.jpg' % epoch, img3)
    g_loss = GC.train_on_batch([horse, zebra], [real_label, real_label, horse, zebra])[0]
