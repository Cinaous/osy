...
class Datasets:
    def __init__(self):
        ...
        self.trainA_save_path = 'datasets/horse_train.npy'
        self.trainB_dir = 'trainB/*.jpg'
        self.trainB_save_path = 'datasets/zebra_train.npy'
        self.testA_dir = 'testA/*.jpg'
        self.testA_save_path = 'datasets/horse_test.npy'
        self.testB_dir = 'testB/*.jpg'
        self.testB_save_path = 'datasets/zebra_test.npy'
    ...
    def load_dataset(data_dir, data_save_path):
        ...
        imgs = [cv2.resize(cv2.imread(path), (128, 128)) for path in glob.glob(data_dir)]
