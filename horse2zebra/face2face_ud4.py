...
from models_model.model_models14 import UNet, Discriminator
import matplotlib.pyplot as plt

batch_size = 1
dataset = Datasets(batch=batch_size)
Z2H = UNet([64, 128, 256, 512])
H2Z = UNet([64, 128, 256, 512])
DH = Discriminator([64, 128, 256, 512], 3)
DZ = Discriminator([64, 128, 256, 512], 3)
...
init_lr = 2e-5 if init_lr is None else init_lr
