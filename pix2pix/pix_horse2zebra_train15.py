...
A2B = RestUNetModel((18, 3), 128, 3, last_layer=kr.layers.Conv2DTranspose(3, 3, padding='same', activation='tanh'))
B2A = RestUNetModel((18, 3), 128, 3, last_layer=kr.layers.Conv2DTranspose(3, 3, padding='same', activation='tanh'))
DA = RestNetModel((9, 3), 128, 3, last_layer=kr.layers.Conv2D(1, 3, padding='same', activation='sigmoid'))
DB = RestNetModel((9, 3), 128, 3, last_layer=kr.layers.Conv2D(1, 3, padding='same', activation='sigmoid'))
...
discriminatorModel.compile(optimizer=kr.optimizers.Adam(lr),
                           loss=kr.losses.mse)
cycle_save_path = './models/cycle15.ckpt'
discriminator_save_path = './models/discriminator15.ckpt'
...
epoch = 0
train_data_save_path = './images/horse2zebra15'
