...
for horse, zebra in dataset:
    ...
    # train G
    DH.trainable, H2Z.trainable, Z2H.trainable = False, True, True
    ...
    # train D
    DH.trainable, H2Z.trainable, Z2H.trainable = True, False, False
    with tf.GradientTape() as tape:
        loss = scc(zebra_label, DH(z_cache(zebra))) + scc(horse_label, DH(h_cache(horse)))
    grads = tape.gradient(loss, DH.trainable_variables)
