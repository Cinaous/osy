...
from models_model.model_rolling_conv3 import UNet, RollingConv
...
Z2H = UNet([(12, 9, 3, 2, cba),
            ...
            (192, 3, 3, 2, cba)])
DH = kr.Sequential([
    RollingConv(12, 9, 3, callback=cba),
    RollingConv(48, 7, 2, callback=cbap),
    RollingConv(96, 5, 2, callback=cbap),
    RollingConv(96, 5, 3, callback=cbapd),
    RollingConv(192, 3, 2, callback=cbapd),
    RollingConv(192, 3, 3, callback=cbapd),
    kr.layers.Dense(2)
])
DZ = kr.Sequential([
    RollingConv(12, 9, 3, callback=cba),
