...
DH = SkipModel(create_skips([(48, 5, 2), (96, 3, 2), (192, 3, 2), (384, 3, 2), (2, 2, 1)], splits=2))
DZ = SkipModel(create_skips([(48, 5, 2), (96, 3, 2), (192, 3, 2), (384, 3, 2), (2, 2, 1)], splits=2))
...
cycle_lambda, z_cache, h_cache, identity_lambda = 5, Cache(), Cache(), 2.5
...
for horse, zebra in dataset:
    ...
    with tf.GradientTape() as tape:
        ...
        h2h = Z2H(horse)
        z2z = H2Z(zebra)
        loss += identity_lambda * (mse(horse, h2h) + mse(zebra, z2z))
