...
discriminatorModel.compile(optimizer=kr.optimizers.Adam(lr),
                           loss=kr.losses.mse)
cycle_save_path = './models/cycle6.ckpt'
discriminator_save_path = './models/discriminator6.ckpt'
...
scaler = Scaler()
real_label = np.ones([dataset.batch_size, 16, 16, 1])
fake_label = np.zeros_like(real_label)

epoch = 0
train_data_save_path = './images/horse2zebra6'
