...
from trm.conv_transformer4 import SkipModel, create_skips
import matplotlib.pyplot as plt
from cache_utils import Cache

batch_size = 1
dataset = Datasets(batch=batch_size)
H2Z = UNet([(12, 5, 2), (48, 3, 2), (96, 3, 2), (192, 3, 2)])
Z2H = UNet([(12, 5, 2), (48, 3, 2), (96, 3, 2), (192, 3, 2)])
DH = SkipModel(create_skips([(12, 5, 2), (48, 3, 2), (96, 3, 2), (2, 3, 1)], splits=2))
DZ = SkipModel(create_skips([(12, 5, 2), (48, 3, 2), (96, 3, 2), (2, 3, 1)], splits=2))
...
cycle_lambda, z_cache, h_cache, identity_lambda = 10, Cache(), Cache(), 5
