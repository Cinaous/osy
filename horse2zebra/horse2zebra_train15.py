...
from models_model.model_models5 import UNet, Discriminator, DCModel, GCModel
...
epoch_save_path = 'outputs/images2/epoch.npy'
epoch, first = 0, True
...
for horse, zebra in dataset:
    if epoch % 2 == 0 or first:
        ...
        cv2.imwrite('outputs/images2/trainA&z_%d.jpg' % epoch, img3)
