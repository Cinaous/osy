...
H_save_path = 'outputs/H11.ckpt'
DH_save_path = 'outputs/DH11.ckpt'
Z_save_path = 'outputs/Z11.ckpt'
DZ_save_path = 'outputs/DZ11.ckpt'
...
def test_show(test_horse=test_horse, test_zebra=test_zebra, delay=0, save=True):
    ...
    if save:
        cv2.imwrite('outputs/test11_out10_%d.jpg' % epoch, img3)
    else:
