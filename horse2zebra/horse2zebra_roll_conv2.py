...
Z2H = UNet([(48, 9, 3, 2, cba),
            ...
            (384, 3, 2, 2, cba)])
DH = kr.Sequential([
    RollingConv(48, 9, 3, callback=cba),
    RollingConv(48, 9, 3, 1, callback=cba),
    RollingConv(96, 7, 2, callback=cbap),
    RollingConv(96, 7, 2, callback=cbap),
    RollingConv(192, 5, 2, callback=cbapd),
    RollingConv(192, 5, 2, callback=cbapd),
    RollingConv(384, 3, callback=cbapd),
    kr.layers.Dense(2)
])
DZ = kr.Sequential([
    RollingConv(48, 9, 3, callback=cba),
