...
A2B = RestUNetModel((18, 3), 256, 3, last_layer=kr.layers.Conv2DTranspose(3, 3, padding='same'))
B2A = RestUNetModel((18, 3), 256, 3, last_layer=kr.layers.Conv2DTranspose(3, 3, padding='same'))
DA = RestNetModel((9, 3), 256, 3, last_layer=kr.layers.Conv2D(1, 3, padding='same'))
DB = RestNetModel((9, 3), 256, 3, last_layer=kr.layers.Conv2D(1, 3, padding='same'))

lr, label = 2e-4, 'horse2zebra19'
